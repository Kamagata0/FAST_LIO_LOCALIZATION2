...
def main():
    ...
    parser.add_argument("--init-x", type=float, default=-3.05, help="Initial X estimate")
    parser.add_argument("--init-y", type=float, default=0.90, help="Initial Y estimate")
    parser.add_argument("--init-yaw", type=float, default=0.611, help="Initial Yaw estimate")
